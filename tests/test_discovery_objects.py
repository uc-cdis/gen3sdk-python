...
def test_discovery_objects_read(
    ...
    guid2_discovery_metadata = {"other_key": "other_val", "objects": []}
    ...
    with tempfile.NamedTemporaryFile(suffix=".tsv", mode="a+") as outfile:
        ...
        required_columns = {"dataset_guid", "guid", "display_name"}
        ...
        assert set(tsv_reader3.fieldnames) == required_columns
        ...
        assert set(tsv_reader4.fieldnames) == required_columns
        tsv_rows4 = list(tsv_reader3)
