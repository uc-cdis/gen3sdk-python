...
# In this case only checking for mis-encoding of an apostrophe in "Parkinson's Disease" that was found in the case and study nodes of some projects: if 'Â' in df_txt or 'Ã' in df_txt; substring = 'Parkinson.*isease'
